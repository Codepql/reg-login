...
public class ArticleController {
    ...
    public Result<List<Article>> myList() {
        return Result.success(articleService.myList());
    }

    // 分页查询我的文章
    @GetMapping("/article/my/page")
    public Result<PageResult<Article>> myPage(Integer pageNum, Integer pageSize) {
        return Result.success(articleService.myPage(pageNum, pageSize));
    }
